...
//interface? for creating a job listing
	...
	public Listing
			( String listingId, String title, String description,  
			  String address, String city, String state, String zipcode, 
			  String salary, String careerField, String contactEmail) {
	...
	public String toString() {
	 ...
	 ",\n Address = " + address + ", City = " + city + ", State = " + state + ", zipcode = " + zipcode +
	  ",\n salary = $" + salary + ".00, careerField = " + careerField + ",\n contactEmail = " + contactEmail + 
